...
func (repo *ProductRepository) Create(product *models.Product) error {
	query := "INSERT INTO product (id, name, price, stock, category_id) VALUES ($1, $2, $3, $4, $5) RETURNING id"
	err := repo.db.QueryRow(query, product.ID, product.Name, product.Price, product.Stock, product.CategoryID).Scan(&product.ID)
	return err
}
